...
const CONSTANT_SIZE: usize = BLOCK_ID_SIZE;
...
impl Packet for BlockRequestPacket {
    ...
    fn from_bytes(bytes: &[u8]) -> Self {
        ...
        block_id.copy_from_slice(&bytes[0..BLOCK_ID_SIZE]);
...
mod tests {
    ...
    const BLOCK_ID: [u8; BLOCK_ID_SIZE] = [
    ...
    #[test]
    fn size() {
        let packet = BlockRequestPacket::new(BlockId::from(BLOCK_ID));
