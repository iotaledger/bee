...
use bee_gossip::{GossipRx as EventRecv, Multiaddr};
...
// FIXME: Tests are temporarily commented because the underlying sending mechanism is not a channel, but a direct socket
// stream. #[cfg(test)]
// mod tests {
//     use super::*;
