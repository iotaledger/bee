...
fn dfs_walker_test<T: StorageBackend>(
    tangle: &Tangle<T>,
    ids: &HashMap<usize, MessageId>,
    root: usize,
    matched: Vec<usize>,
    skipped: Vec<usize>,
    missing: Vec<usize>,
    condition: Option<Box<dyn Fn(&Tangle<T>, &MessageId, &MessageData) -> bool>>,
) {
...
#[allow(clippy::type_complexity)]
fn bfs_walker_test<T: StorageBackend>(
    tangle: &Tangle<T>,
    ids: &HashMap<usize, MessageId>,
    root: usize,
    matched: Vec<usize>,
...
fn binary_tree() {
    ...
    fn condition<T: StorageBackend>(_tangle: &Tangle<T>, message_id: &MessageId, _message_data: &MessageData) -> bool {
