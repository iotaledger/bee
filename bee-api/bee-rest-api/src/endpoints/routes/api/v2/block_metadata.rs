...
use crate::{
    endpoints::{
        config::ROUTE_BLOCK_METADATA, filters::with_tangle, path_params::block_id, permission::has_permission,
...
pub(crate) fn filter<B: StorageBackend>(
    ...
    self::path()
        .and(warp::get())
        .and(has_permission(ROUTE_BLOCK_METADATA, public_routes, allowed_ips))
