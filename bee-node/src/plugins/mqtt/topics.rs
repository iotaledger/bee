...
pub(crate) const _TOPIC_MESSAGES_METADATA: &'static str = "messages/{messageId}/metadata";
pub(crate) const _TOPIC_OUTPUTS: &'static str = "outputs/{outputId}";
pub(crate) const _TOPIC_ADDRESSES_OUTPUTS: &'static str = "addresses/{address}/outputs";
pub(crate) const _TOPIC_ADDRESSES_ED25519_OUTPUT: &'static str = "addresses/ed25519/{address}/outputs";
