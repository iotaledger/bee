...
pub(crate) const TOPIC_MILESTONES_SOLID: &str = "milestones/confirmed";
...
pub(crate) const TOPIC_TRANSACTION_INCLUDED_MESSAGE: &str = "transactions/[transactionId]/included-message";
