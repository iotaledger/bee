...
#[must_use]
pub struct ChrysalisRegularTransactionEssenceBuilder {
    inputs: Vec<Input>,
    outputs: Vec<Output>,
    payload: Option<Payload>,
}

impl ChrysalisRegularTransactionEssenceBuilder {
    ...
    pub fn finish(self) -> Result<ChrysalisRegularTransactionEssence, Error> {
        ...
        Ok(ChrysalisRegularTransactionEssence {
            inputs,
            outputs,
            payload,
        })
...
pub struct ChrysalisRegularTransactionEssence {
...
impl ChrysalisRegularTransactionEssence {
    ...
    pub fn builder() -> ChrysalisRegularTransactionEssenceBuilder {
