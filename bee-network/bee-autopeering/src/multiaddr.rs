...
// stores the address part and the key part separately. The details are abstracted away and the behaviour identical
// to a standard libp2p multiaddress.

/// Represents a special type of [`Multiaddr`] used to describe peers that participate in autopeering, i.e. make
