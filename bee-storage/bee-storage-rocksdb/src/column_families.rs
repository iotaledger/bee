...
pub const CF_BLOCK_ID_TO_BLOCK: &str = "block_id_to_block";
pub const CF_BLOCK_ID_TO_METADATA: &str = "block_id_to_metadata";
pub const CF_BLOCK_ID_TO_BLOCK_ID: &str = "block_id_to_block_id";
...
pub const CF_MILESTONE_INDEX_TO_UNREFERENCED_BLOCK: &str = "milestone_index_to_unreferenced_block";
