...
pub const CF_MESSAGE_ID_TO_MESSAGE: &str = "block_id_to_block";
pub const CF_MESSAGE_ID_TO_METADATA: &str = "block_id_to_metadata";
pub const CF_MESSAGE_ID_TO_MESSAGE_ID: &str = "block_id_to_block_id";
...
pub const CF_MILESTONE_INDEX_TO_MILESTONE_METADATA: &str = "milestone_index_to_milestone_metadata";
pub const CF_MILESTONE_ID_TO_MILESTONE_PAYLOAD: &str = "milestone_id_to_milestone_payload";
...
pub const CF_MILESTONE_INDEX_TO_UNREFERENCED_MESSAGE: &str = "milestone_index_to_unreferenced_block";
