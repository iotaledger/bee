...
mod alias_address_to_output_id;
...
pub use alias_address_to_output_id::alias_address_to_output_id_access;
...
pub use nft_address_to_output_id::nft_address_to_output_id_access;
