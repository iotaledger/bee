...
| Name                              | Description                                                                 | Type              |
| :-------------------------------- | :-------------------------------------------------------------------------- | :---------------- |
| bind_address                      | REST API bind address.                                                      | string[Multiaddr] |
| jwt_salt                          | JWT salt for REST API                                                       | string            |
| public_routes                     | Routes that are available for public use and don't need JWT authentication. | array of strings  |
| protected_routes                  | Routes that are protected and need JWT authentication.                      | array of strings  |
| feature_proof_of_work             | Enables/disables the proof-of-work feature on the node.                     | bool              |
| white_flag_solidification_timeout | Describes the white flag solidification timeout.                            | integer[u64]      |
