...
pub async fn prune<S: StorageBackend>(
    ...
    for index in *start_index..=*target_index {
        ...
        metrics.blocks = confirmed_data_metrics.prunable_blocks;
        ...
        // block directly referencing it. In Bee, however, we wanted to try a different approach, which doesn't
        ...
        metrics.blocks += unconfirmed_data_metrics.prunable_blocks;
